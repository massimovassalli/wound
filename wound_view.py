...
class Ui_facewindow(object):
    def setupUi(self, facewindow):
        ...
        self.menuBar.setGeometry(QtCore.QRect(0, 0, 848, 19))
        ...
        self.actionAdd_2 = QtWidgets.QAction(facewindow)
        self.actionAdd_2.setObjectName("actionAdd_2")
        self.actionRemove_2 = QtWidgets.QAction(facewindow)
        self.actionRemove_2.setObjectName("actionRemove_2")
        self.actionAdd_3 = QtWidgets.QAction(facewindow)
        self.actionAdd_3.setObjectName("actionAdd_3")
        self.actionRemove_3 = QtWidgets.QAction(facewindow)
        ...
        self.menuWell.addAction(self.actionAdd_2)
        self.menuWell.addAction(self.actionRemove_2)
        self.menuWell.addAction(self.actionProcess)
        self.menuWell.addAction(self.actionStitch)
        self.menuPicture.addAction(self.actionAdd_3)
        self.menuPicture.addAction(self.actionRemove_3)
    ...
    def retranslateUi(self, facewindow):
        ...
        self.actionAdd_2.setText(_translate("facewindow", "Add"))
        self.actionRemove_2.setText(_translate("facewindow", "Remove"))
        self.actionAdd_3.setText(_translate("facewindow", "Add"))
        self.actionRemove_3.setText(_translate("facewindow", "Remove"))
